...
const char *VERSION = "Version 2.0, Build Date: " __DATE__;
...
#ifdef _DEBUG
const char *XR_CONFIG_FILE = "Orbitersdk\\dougb\\XR2Ravenstar\\XR2RavenstarPrefs.cfg";
#else
...
const DamageItem D_END = BayDoors;
