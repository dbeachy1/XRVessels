...
//
// XR3Areas.h
// Header for new areas for the XR3.
// ==============================================================
...
// XR3 areas should extend XR1Area
#define GetXR3() (static_cast<XR3Phoenix &>(GetVessel()))
...
class XR3CrewDisplayArea : public CrewDisplayArea
{
public:
    XR3CrewDisplayArea(InstrumentPanel &parentPanel, const COORD2 panelCoordinates, const int areaID);
};
...
class XR3ReentryCheckMultiDisplayMode : public ReentryCheckMultiDisplayMode
{
public:
    // Constructor
    XR3ReentryCheckMultiDisplayMode(int modeNumber);
