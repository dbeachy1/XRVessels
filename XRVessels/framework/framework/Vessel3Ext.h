// ==============================================================
// XR framework base class that extends VESSEL3; all XR vessels extend this class.
//
...
// vessel3ext.h
// 
// Class defining an extended VESSEL2 class for use with the new cockpit framework.
// ==============================================================
